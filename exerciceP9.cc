...
int main() {
	...
	systeme.ajouter_champ(new Vide); //création d'un champ de force vide (ne fait rien), ce sera le champ de force agissant sur la Terre
	systeme.ajouter_champ(new ChampNewtonien(*systeme.get_objet(0), prec)); //création du champ de force Newtonien de la Terre
