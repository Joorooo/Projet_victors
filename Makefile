...
ChampForces.o Vide.o ForceUniforme.o GravitationConstante.o Contraintes.o Libre.o IntegrateurEulerCromer.o \
...
clean:
	rm -f *.o exerciceP9 exerciceP9-3.1
