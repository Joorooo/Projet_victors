...
class ObjetMobile {
	...
	virtual std::ostream& affiche_primaire(std::ostream& sortie) const; 
	virtual std::ostream& affiche(std::ostream& sortie) const; //retourne pour l'instant la même chose que méthode affiche_primaire
