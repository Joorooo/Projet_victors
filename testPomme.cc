...
int main() {
	...
	Vecteur E_T({-Constantes::r_terre}); //vecteur d'une dimension représentant la position sur droite verticale passant par la pomme et le centre de la Terre
	Vecteur E_P({10.0});
	...
	for (size_t i(0); i <= n; i++) {
		if (i%100 == 0) { //affichage tous les 100 pas de calcul
			cout << t << " # temps" << endl;
			Pomme.ObjetMobile::affiche_primaire(cout); //affichage les attributs E et E_prime de Pomme 
			cout << endl;
			cout << "=====================" << endl;
		}
